...
if (isset($_POST['register'])) {
    ...
    $sql = "INSERT INTO customers (customer_name, password_hashed, customer_birth, customer_gender, customer_mail, customer_phone, token, role) VALUES (?,?,?,?,?,?,?,?)";
    $stmt = mysqli_prepare($conn, $sql);
    mysqli_stmt_bind_param($stmt, "sssissss", $name, md5($password), $birth, $gender, $mail, $phone, $token, $role);
                        ...
                        <form id="registerForm" action="register.php" method="POST">
                            ...
                            <div class="step d-none">
                                ...
                                <select name="gender" class="form-select" id="gender" required>
                                    ...
                                    <option value="0">Do not want to answer</option>
                                </select>
                                <button type="button" class="btn btn-secondary mt-3 w-100"
                                    onclick="prevStep(6)">Back</button>
                                <input class="btn btn-success mt-3 w-100" type="submit" name="register"
                                    value="Register">
                            </div>
                        </form>
                    </div>
